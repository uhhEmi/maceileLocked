...
public class ModConfig {
    ...
    public static int pingCooldown = 40; // Global cooldown between any pings (in ticks)
    ...
    public static int fovCirclePingCooldown = 20; // Per-box cooldown for FOV circle pings (in ticks)
